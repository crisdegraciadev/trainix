...
export default function ExerciseDetails({ name, videoUrl, favourite, description, difficulty, muscles }: Exercise) {
  return (
    <div className="flex flex-col space-y-4">
      {
        <div className="relative w-full cursor-pointer border rounded-lg border-gray-200" onClick={() => videoUrl && window.open(videoUrl, "_blank")}>
          {videoUrl && (
